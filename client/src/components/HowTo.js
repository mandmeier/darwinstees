...
const HowTo = () => {
    return (
        <How>
            ...
            <ol>
                <li><strong><em className="emph">variation</em></strong> Once per week, each design produces a "litter" of three mutant designs. The mutant designs are similar to their parent, but not identical.</li>
